...
function selectLeaveRecord(){	
	window.location.href = "leaveRecordForTeacher.jsp";
}
...
<body style="margin:1px;">
	<table id="dg" title="请假情况" class="easyui-datagrid" fitColumns="true"  pagination="true"  rownumbers="true"
	 url="${pageContext.request.contextPath}/sysLeaveAction/getLeaveInformationByTeacher.do" fit="true" toolbar="#tb">
	 <thead>
	 	<tr>
	...
	<div id="tb">
		<div style = "">
			<a href="javascript:leaveApplicationStatus( '同意' , 6)" class="easyui-linkbutton" iconCls="icon-add" plain="true">同意</a>			
			<a href="javascript:leaveApplicationStatus( '驳回' , 4)" class="easyui-linkbutton" iconCls="icon-edit" plain="true">驳回</a>
		    <a href="javascript:selectLeaveRecord()" class="easyui-linkbutton" iconCls="icon-add" plain="true">查看学生请假记录</a>
